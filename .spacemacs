...
values."
  ...
  (setq-default
   ...
   ;; Iith 2 themes variants, one dark and one light)
    ...
    (let ((root (ignore-errors (projectile-project-root))))
      (when root
        (add-to-list
         ...
         (concat (file-name-as-directory root) c-project-include))))))
...
you should place your code here."
  (add-hook 'hack-local-variables-hook 'config-after-local-variables)
...
(custom-set-variables
 ...
 '(powerline-height 28)
 '(safe-local-variable-values (quote ((c-project-include . "include"))))
